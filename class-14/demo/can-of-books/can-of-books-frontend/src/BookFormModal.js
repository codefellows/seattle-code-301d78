...
/*
NOTE: This is for your consideration.
It is one form being able to handle both
creating and updating.
If that's difficult to work with then 
start with separate, dedicated forms.

You can always combine them later if you choose to.
*/
